...
set rc [catch {
  ...
  set_property ip_repo_paths /home/ecestudent/ECE2700/processor/processor.cache/ip [current_project]
  set_property ip_output_repo /home/ecestudent/ECE2700/processor/processor.cache/ip [current_project]
  add_files -quiet /home/ecestudent/ECE2700/processor/processor.runs/synth_1/processor.dcp
