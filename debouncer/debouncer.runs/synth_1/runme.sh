...
HD_PWD='/home/ecestudent/ECE2700/debouncer/debouncer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DebounceCounter.vds -m64 -mode batch -messageDb vivado.pb -notrace -source DebounceCounter.tcl
