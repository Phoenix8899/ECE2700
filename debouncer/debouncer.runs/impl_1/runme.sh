...
HD_PWD='/home/ecestudent/ECE2700/debouncer/debouncer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DebounceCounter.vdi -applog -m64 -messageDb vivado.pb -mode batch -source DebounceCounter.tcl -notrace
