...
HD_PWD='/home/ecestudent/ECE2700/Lab3/Adder16/Adder16.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CarrySixteen.vdi -applog -m64 -messageDb vivado.pb -mode batch -source CarrySixteen.tcl -notrace
