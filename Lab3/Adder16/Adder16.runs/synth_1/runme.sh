...
HD_PWD='/home/ecestudent/ECE2700/Lab3/Adder16/Adder16.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CarrySixteen.vds -m64 -mode batch -messageDb vivado.pb -notrace -source CarrySixteen.tcl
