...
HD_PWD='/home/ecestudent/ECE2700/DoubleSevenSegment/DoubleSevenSegment.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DoubbleSevenSegment.vds -m64 -mode batch -messageDb vivado.pb -notrace -source DoubbleSevenSegment.tcl
