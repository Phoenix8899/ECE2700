...
HD_PWD='/home/ecestudent/ECE2700/DoubleSevenSegment/DoubleSevenSegment.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DoubbleSevenSegment.vdi -applog -m64 -messageDb vivado.pb -mode batch -source DoubbleSevenSegment.tcl -notrace
