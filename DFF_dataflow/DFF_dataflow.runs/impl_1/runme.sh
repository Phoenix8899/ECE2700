...
HD_PWD='/home/ecestudent/ECE2700/DFF_dataflow/DFF_dataflow.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log JKFF.vdi -applog -m64 -messageDb vivado.pb -mode batch -source JKFF.tcl -notrace
