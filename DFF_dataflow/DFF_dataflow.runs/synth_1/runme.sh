...
HD_PWD='/home/ecestudent/ECE2700/DFF_dataflow/DFF_dataflow.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log JKFF.vds -m64 -mode batch -messageDb vivado.pb -notrace -source JKFF.tcl
